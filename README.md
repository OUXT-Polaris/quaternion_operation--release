## quaternion_operation (foxy) - 0.0.11-1

The packages in the `quaternion_operation` repository were released into the `foxy` distro by running `/usr/bin/bloom-release --track foxy --ros-distro foxy quaternion_operation` on `Thu, 10 Feb 2022 08:04:10 -0000`
...
## quaternion_operation (galactic) - 0.0.11-1

The packages in the `quaternion_operation` repository were released into the `galactic` distro by running `/usr/bin/bloom-release --track galactic --ros-distro galactic quaternion_operation` on `Thu, 10 Feb 2022 08:02:39 -0000`
